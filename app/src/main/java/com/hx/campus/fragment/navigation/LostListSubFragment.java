...
public class LostListSubFragment extends BaseFragment<LayoutCommonListBinding> {
    private String mTabTitle;
    private LostFoundRecyclerAdapter mAdapter;

    public static LostListSubFragment newInstance(String title) {
        LostListSubFragment fragment = new LostListSubFragment();
    ...
    private void loadData() {
        RetrofitClient.getInstance().getApi().DetailByTitle(mTabTitle, "失物")
